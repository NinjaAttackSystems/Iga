...
namespace GerberView
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                cameras.Items.Add(camera.Name);
            }

            cameras.SelectedIndex = 0;

            videoCaptureDevice = filterInfoCollection.Count > 0 ? new VideoCaptureDevice(filterInfoCollection[cameras.SelectedIndex].MonikerString) : new VideoCaptureDevice();
            ...
            tableLayoutPanel2.Width = splitContainer1.Panel2.Width;
            tableLayoutPanel2.Height = splitContainer1.Panel2.Height;
        ...
        private void TranslateImage()
        {
            ...
            gerberLib.TranslateToZero(project, renderInfo);
            //
            // else
        ...
        private void PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            gerberLib.TranslateToZero(project, printRenderInfo);
        ...
        private void syncWebcamLocation_Click(object sender, EventArgs e)
        {
            var info = selectionInfo;
            var location = new Point(this.Left, this.Top);
            logTextBox.AppendText(info.SelectedNodeArray.SelectedNetIndex.ToString());
            logTextBox.AppendText(location.ToString());
        }
